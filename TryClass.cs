...
namespace gradesBookApp
{
    internal class TryClass
    {
        ...
        //            private HashSet<DataGridViewCell> changedCells = new HashSet<DataGridViewCell>();
        ...
        //            {
        //                dataGridView1.Columns["student_id"].ReadOnly = true;
        //                dataGridView1.Columns["student_name"].ReadOnly = true;
        //                dataGridView1.Columns["Final Grade"].ReadOnly = true;
        //                dataGridView1.Columns["Equivalident Grade"].ReadOnly = true;
        ...
        //                    string tableName = u.GetTableName(cell.OwningColumn.HeaderText);
        //                    string columnName = cell.OwningColumn.HeaderText;
        //                    int newValue = Convert.ToInt32(cell.Value);

        //                    u.UpdateGradebook(tableName, columnName, newValue, row);
        //                }
        ...
        //                string newValueStr = cell.Value?.ToString();
        //                if (!int.TryParse(newValueStr, out int newValue))
        //                {
        //                    // Invalid value, revert to the original value
        ...
        //                if (!ValidateValue(newValue, row, e.ColumnIndex))
        //                {
        //                    // Validation failed, revert to the original value
        //                    cell.Value = originalValue;
        //                    return;
        //                }

        //                // Valid value, update the database
        //                string tableName = u.GetTableName(cell.OwningColumn.HeaderText);
        //                string columnName = cell.OwningColumn.HeaderText;
        //                u.UpdateGradebook(tableName, columnName, newValue, row);
        //            }

        //            private bool ValidateValue(int newValue, DataGridViewRow row, int columnIndex)
        //            {
        //                v.isNumberforDB(newValue.ToString());
        //                // For example, comparing the current cell value with the next cell value
        //                if (columnIndex + 1 < row.Cells.Count)
        //                {
        //                    var nextCell = row.Cells[columnIndex + 1];
        //                    if (int.TryParse(nextCell.Value?.ToString(), out int nextValue))
        //                    {
        ...
        //                {
        //                    MessageBox.Show("Please enter a number between 0 and 100.", "Invalid Input", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        //                    return false;
        //                }
